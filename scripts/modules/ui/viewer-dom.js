export function collectViewerDom(document) {
    ...
    return {
        ...
        mapBuildingsToggle: get('mapBuildingsToggle'),
        mapBuildingsStatus: get('mapBuildingsStatus'),
        mapBuildingsProgress: get('mapBuildingsProgress'),
        map2gisAttribution: get('map2gisAttribution'),
        mapOsmAttribution: get('mapOsmAttribution'),
